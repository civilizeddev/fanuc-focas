 ...
 */
public class alminfo2 extends Structure {
	public u_union u;
	public static class u_union extends Union {
		...
		public static class alm1_struct extends Structure {
			...
			public static class alm_struct extends Structure {
				...
				public alm_struct(short axis, short alm_no) {
					super();
					this.axis = axis;
					this.alm_no = alm_no;
				}
		...
		public static class alm2_struct extends Structure {
			...
			public static class alm_struct extends Structure {
				...
				public byte[] alm_msg = new byte[34];
				public alm_struct() {
					super();
				}
				protected List<String> getFieldOrder() {
				...
				public alm_struct(short axis, short alm_no, short msg_len, byte alm_msg[]) {
					super();
					this.axis = axis;
					this.alm_no = alm_no;
	...
	public alminfo2(u_union u) {
		super();
		this.u = u;
	}
	public alminfo2(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends alminfo2 implements Structure.ByReference {
		
	};
	public static class ByValue extends alminfo2 implements Structure.ByValue {
