 ...
 */
public class OUT_FLNTPRM extends Structure {
	...
	public static class ByReference extends OUT_FLNTPRM implements Structure.ByReference {
		
	};
	public static class ByValue extends OUT_FLNTPRM implements Structure.ByValue {
