 ...
 */
public class iodbpsd64 extends Structure {
	/** data number */
	public short datano;
	/** data type */
	public short type;
	...
	public iodbpsd64(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends iodbpsd64 implements Structure.ByReference {
		
	};
	public static class ByValue extends iodbpsd64 implements Structure.ByValue {
