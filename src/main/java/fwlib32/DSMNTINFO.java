 ...
 */
public class DSMNTINFO extends Structure {
	...
	public DSMNTINFO(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends DSMNTINFO implements Structure.ByReference {
		
	};
	public static class ByValue extends DSMNTINFO implements Structure.ByValue {
