 ...
 */
public class odbdy2 extends Structure {
	public short dummy;
	/** axis number */
	public short axis;
	/** alarm status */
	...
	public odbdy2(short dummy, short axis, NativeLong alarm, NativeLong prgnum, NativeLong prgmnum, NativeLong seqnum, NativeLong actf, NativeLong acts, pos_union pos) {
		super();
		this.dummy = dummy;
		this.axis = axis;
		this.alarm = alarm;
	...
	public odbdy2(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbdy2 implements Structure.ByReference {
		
	};
	public static class ByValue extends odbdy2 implements Structure.ByValue {
