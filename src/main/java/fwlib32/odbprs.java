 ...
 */
public class odbprs extends Structure {
	/** dummy */
	public short datano;
	/** dummy */
	public short type;
	...
	public odbprs(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbprs implements Structure.ByReference {
		
	};
	public static class ByValue extends odbprs implements Structure.ByValue {
