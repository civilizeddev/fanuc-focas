 ...
 */
public class iodbsig3 extends Structure {
	/** dummy */
	public short datano;
	/** dummy */
	public short type;
	public fwlib32.iodbprm.data_struct[] data = new fwlib32.iodbprm.data_struct[60];
	...
	public iodbsig3(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends iodbsig3 implements Structure.ByReference {
		
	};
	public static class ByValue extends iodbsig3 implements Structure.ByValue {
