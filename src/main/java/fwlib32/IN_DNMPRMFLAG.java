 ...
 */
public class IN_DNMPRMFLAG extends Structure {
	public flg_union flg;
	public static class flg_union extends Union {
		public IN_DNMPRMFLAG_BUS bus;
		public IN_DNMPRMFLAG_SLAVE slave;
		public flg_union() {
			super();
		}
		public flg_union(IN_DNMPRMFLAG_BUS bus) {
			super();
			this.bus = bus;
			setType(IN_DNMPRMFLAG_BUS.class);
		}
	...
	public IN_DNMPRMFLAG(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends IN_DNMPRMFLAG implements Structure.ByReference {
		
	};
	public static class ByValue extends IN_DNMPRMFLAG implements Structure.ByValue {
