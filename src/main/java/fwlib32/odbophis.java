 ...
 */
public class odbophis extends Structure {
	/** length */
	...
	public odbophis(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbophis implements Structure.ByReference {
		
	};
	public static class ByValue extends odbophis implements Structure.ByValue {
