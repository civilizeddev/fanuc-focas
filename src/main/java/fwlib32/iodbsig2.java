 ...
 */
public class iodbsig2 extends Structure {
	/** dummy */
	public short datano;
	/** dummy */
	public short type;
	public fwlib32.iodbprm.data_struct[] data = new fwlib32.iodbprm.data_struct[45];
	...
	public iodbsig2(short datano, short type, fwlib32.iodbprm.data_struct data[]) {
		super();
		this.datano = datano;
		this.type = type;
	...
	public iodbsig2(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends iodbsig2 implements Structure.ByReference {
		
	};
	public static class ByValue extends iodbsig2 implements Structure.ByValue {
