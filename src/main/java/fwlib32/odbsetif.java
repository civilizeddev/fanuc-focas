 ...
 */
public class odbsetif extends Structure {
	...
	public odbsetif(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbsetif implements Structure.ByReference {
		
	};
	public static class ByValue extends odbsetif implements Structure.ByValue {
