 ...
 */
public class odbsv2_grp4 extends Structure {
	...
	public odbsv2_grp4(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbsv2_grp4 implements Structure.ByReference {
		
	};
	public static class ByValue extends odbsv2_grp4 implements Structure.ByValue {
