 ...
 */
public class odbahis3 extends Structure {
	/** start number */
	public short s_no;
	/** end number */
	public short e_no;
	...
	public odbahis3(short s_no, short e_no, fwlib32.odbahis.alm_his_struct alm_his[]) {
		super();
		this.s_no = s_no;
		this.e_no = e_no;
	...
	public odbahis3(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbahis3 implements Structure.ByReference {
		
	};
	public static class ByValue extends odbahis3 implements Structure.ByValue {
