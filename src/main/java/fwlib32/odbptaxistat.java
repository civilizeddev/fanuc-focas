 ...
 */
public class odbptaxistat extends Structure {
	public u_union u;
	...
	public odbptaxistat(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbptaxistat implements Structure.ByReference {
		
	};
	public static class ByValue extends odbptaxistat implements Structure.ByValue {
