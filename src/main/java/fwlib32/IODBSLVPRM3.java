 ...
 */
public class IODBSLVPRM3 extends Structure {
	...
	public static class ByReference extends IODBSLVPRM3 implements Structure.ByReference {
		
	};
	public static class ByValue extends IODBSLVPRM3 implements Structure.ByValue {
