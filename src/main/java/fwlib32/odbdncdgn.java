 ...
 */
public class odbdncdgn extends Structure {
	public short ctrl_word;
	public short can_word;
	public byte[] nc_file = new byte[16];
	...
	public odbdncdgn(short ctrl_word, short can_word, byte nc_file[], short read_ptr, short write_ptr, short empty_cnt, NativeLong total_size) {
		super();
	...
	public odbdncdgn(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbdncdgn implements Structure.ByReference {
		
	};
	public static class ByValue extends odbdncdgn implements Structure.ByValue {
