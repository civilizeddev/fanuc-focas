 ...
 */
public class odbdyo8 extends Structure {
	public short dummy;
	/** axis number */
	public short axis;
	/** alarm status */
	...
	public odbdyo8(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbdyo8 implements Structure.ByReference {
		
	};
	public static class ByValue extends odbdyo8 implements Structure.ByValue {
