 ...
 */
public class odbalmmsg extends Structure {
	...
	public odbalmmsg(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbalmmsg implements Structure.ByReference {
		
	};
	public static class ByValue extends odbalmmsg implements Structure.ByValue {
