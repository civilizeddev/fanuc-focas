 ...
 */
public class IN_PBSPRMFLG2 extends Structure {
	...
	public static class ByReference extends IN_PBSPRMFLG2 implements Structure.ByReference {
		
	};
	public static class ByValue extends IN_PBSPRMFLG2 implements Structure.ByValue {
