 ...
 */
public class OUT_CCLRPRM extends Structure {
	...
	public static class ByReference extends OUT_CCLRPRM implements Structure.ByReference {
		
	};
	public static class ByValue extends OUT_CCLRPRM implements Structure.ByValue {
