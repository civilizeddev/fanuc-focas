 ...
 */
public class OUT_FLNTEACHMSG extends Structure {
	public short MsgId;
	public byte Year;
	public byte Month;
	public byte Day;
	...
	public OUT_FLNTEACHMSG(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends OUT_FLNTEACHMSG implements Structure.ByReference {
		
	};
	public static class ByValue extends OUT_FLNTEACHMSG implements Structure.ByValue {
