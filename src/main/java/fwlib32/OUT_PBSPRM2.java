 ...
 */
public class OUT_PBSPRM2 extends Structure {
	...
	public OUT_PBSPRM2(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends OUT_PBSPRM2 implements Structure.ByReference {
		
	};
	public static class ByValue extends OUT_PBSPRM2 implements Structure.ByValue {
