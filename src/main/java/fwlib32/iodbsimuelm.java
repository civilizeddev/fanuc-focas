 ...
 */
public class iodbsimuelm extends Structure {
	public byte type;
	public byte rot_w;
	public byte type2;
	public byte plane;
	...
	public static class ByReference extends iodbsimuelm implements Structure.ByReference {
		
	};
	public static class ByValue extends iodbsimuelm implements Structure.ByValue {
