...
public class iodbto extends Structure {
	...
	public static class u_union extends Union {
		...
		public fwlib32.iodbpsd64.u_union.m_ofs_at_struct[] m_ofs_at = new fwlib32.iodbpsd64.u_union.m_ofs_at_struct[5];
		public fwlib32.iodbpsd64.u_union.m_ofs_bt_struct[] m_ofs_bt = new fwlib32.iodbpsd64.u_union.m_ofs_bt_struct[5];
		public fwlib32.iodbpsd64.u_union.m_ofs_ct_struct[] m_ofs_ct = new fwlib32.iodbpsd64.u_union.m_ofs_ct_struct[5];
		/** T Each, 2-byte */
		public short[] t_tip = new short[5];
		/** T Each, 4-byte */
		public NativeLong[] t_ofs = new NativeLong[5];
		public fwlib32.iodbpsd64.u_union.t_ofs_a_struct[] t_ofs_a = new fwlib32.iodbpsd64.u_union.t_ofs_a_struct[5];
		public fwlib32.iodbpsd64.u_union.t_ofs_b_struct[] t_ofs_b = new fwlib32.iodbpsd64.u_union.t_ofs_b_struct[5];
		/** T-2nd geometry */
		public NativeLong[] t_ofs_2g = new NativeLong[15];
		/** M-CornerR */
		public NativeLong[] m_ofs_cnr = new NativeLong[10];
		public fwlib32.iodbpsd64.u_union.t_ofs_ex_struct[] t_ofs_ex = new fwlib32.iodbpsd64.u_union.t_ofs_ex_struct[5];
		...
		public u_union(fwlib32.iodbpsd64.u_union.m_ofs_at_struct m_ofs_at[]) {
			super();
			if ((m_ofs_at.length != this.m_ofs_at.length)) 
				throw new IllegalArgumentException("Wrong array size !");
			this.m_ofs_at = m_ofs_at;
			setType(fwlib32.iodbpsd64.u_union.m_ofs_at_struct[].class);
		}
		public u_union(fwlib32.iodbpsd64.u_union.m_ofs_bt_struct m_ofs_bt[]) {
			super();
			if ((m_ofs_bt.length != this.m_ofs_bt.length)) 
				throw new IllegalArgumentException("Wrong array size !");
			this.m_ofs_bt = m_ofs_bt;
			setType(fwlib32.iodbpsd64.u_union.m_ofs_bt_struct[].class);
		}
		public u_union(fwlib32.iodbpsd64.u_union.m_ofs_ct_struct m_ofs_ct[]) {
			super();
			if ((m_ofs_ct.length != this.m_ofs_ct.length)) 
				throw new IllegalArgumentException("Wrong array size !");
			this.m_ofs_ct = m_ofs_ct;
			setType(fwlib32.iodbpsd64.u_union.m_ofs_ct_struct[].class);
		}
		...
		public u_union(fwlib32.iodbpsd64.u_union.t_ofs_a_struct t_ofs_a[]) {
			super();
			if ((t_ofs_a.length != this.t_ofs_a.length)) 
				throw new IllegalArgumentException("Wrong array size !");
			this.t_ofs_a = t_ofs_a;
			setType(fwlib32.iodbpsd64.u_union.t_ofs_a_struct[].class);
		}
		public u_union(fwlib32.iodbpsd64.u_union.t_ofs_b_struct t_ofs_b[]) {
			super();
			if ((t_ofs_b.length != this.t_ofs_b.length)) 
				throw new IllegalArgumentException("Wrong array size !");
			this.t_ofs_b = t_ofs_b;
			setType(fwlib32.iodbpsd64.u_union.t_ofs_b_struct[].class);
		}
		public u_union(fwlib32.iodbpsd64.u_union.t_ofs_ex_struct t_ofs_ex[]) {
			super();
			if ((t_ofs_ex.length != this.t_ofs_ex.length)) 
				throw new IllegalArgumentException("Wrong array size !");
			this.t_ofs_ex = t_ofs_ex;
			setType(fwlib32.iodbpsd64.u_union.t_ofs_ex_struct[].class);
		}
