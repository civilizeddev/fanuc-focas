 ...
 */
public class odbahis4 extends Structure {
	/** start number */
	public short s_no;
	/** end number */
	public short e_no;
	...
	public static class alm_his_struct extends Structure {
		...
		protected List<String> getFieldOrder() {
			return Arrays.asList("alm_grp", "alm_no", "axis_no", "year", "month", "day", "hour", "minute", "second", "len_msg", "pth_no", "dummy", "alm_msg");
		}
	...
	public odbahis4(short s_no, short e_no, fwlib32.odbahis.alm_his_struct alm_his[]) {
		super();
		this.s_no = s_no;
		this.e_no = e_no;
	...
	public odbahis4(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbahis4 implements Structure.ByReference {
		
	};
	public static class ByValue extends odbahis4 implements Structure.ByValue {
