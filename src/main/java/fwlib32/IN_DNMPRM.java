 ...
 */
public class IN_DNMPRM extends Structure {
	public prm_union prm;
	public static class prm_union extends Union {
		public IN_DNMPRM_BUS bus;
		public IN_DNMPRM_SLAVE slave;
		public prm_union() {
			super();
		}
		public prm_union(IN_DNMPRM_BUS bus) {
			super();
			this.bus = bus;
			setType(IN_DNMPRM_BUS.class);
		}
	...
	public IN_DNMPRM(prm_union prm) {
		super();
		this.prm = prm;
	}
	public IN_DNMPRM(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends IN_DNMPRM implements Structure.ByReference {
		
	};
	public static class ByValue extends IN_DNMPRM implements Structure.ByValue {
