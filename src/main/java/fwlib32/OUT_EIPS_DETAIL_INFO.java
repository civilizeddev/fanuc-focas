 ...
 */
public class OUT_EIPS_DETAIL_INFO extends Structure {
	public short Result;
	public byte[] pad1 = new byte[2];
	public byte[] IpAddress = new byte[40];
	public byte GeneralCode;
	public byte pad2;
	public short ExtendedCode;
	...
	public static class ByReference extends OUT_EIPS_DETAIL_INFO implements Structure.ByReference {
		
	};
	public static class ByValue extends OUT_EIPS_DETAIL_INFO implements Structure.ByValue {
