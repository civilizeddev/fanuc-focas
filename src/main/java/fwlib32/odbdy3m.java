 ...
 */
public class odbdy3m extends Structure {
	public short dummy;
	/** axis number */
	public short axis;
	/** alarm status */
	...
	public odbdy3m(short dummy, short axis, NativeLong alarm, NativeLong prgnum, NativeLong prgmnum, NativeLong seqnum, NativeLong actf, NativeLong acts, pos_union pos) {
		super();
		this.dummy = dummy;
		this.axis = axis;
		this.alarm = alarm;
	...
	public odbdy3m(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends odbdy3m implements Structure.ByReference {
		
	};
	public static class ByValue extends odbdy3m implements Structure.ByValue {
