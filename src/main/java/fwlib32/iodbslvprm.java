 ...
 */
public class iodbslvprm extends Structure {
	...
	public iodbslvprm(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends iodbslvprm implements Structure.ByReference {
		
	};
	public static class ByValue extends iodbslvprm implements Structure.ByValue {
