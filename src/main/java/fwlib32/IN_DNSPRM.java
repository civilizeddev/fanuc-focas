 ...
 */
public class IN_DNSPRM extends Structure {
	...
	public static class ByReference extends IN_DNSPRM implements Structure.ByReference {
		
	};
	public static class ByValue extends IN_DNSPRM implements Structure.ByValue {
